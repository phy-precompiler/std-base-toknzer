/** Token type definitions. REMINDER: the token constant values DOES NOT keep 
 * consistent acrosss python versions. The int value which represents certain 
 * token type DOES NOT necessarily mean it represents the same type in other 
 * python versions.
 * 
 * Any other symbols that are not related to token type constants are ignored.
*/
...
/// macros non-related to token type constants
/// #ifdef __cplusplus
/// extern "C" {
/// #endif
...
/// token types are all version-specific
...
/// missing token types
#define TSTRING_START   128
#define TSTRING_MIDDLE  129
#define TSTRING_END     130
...
/// missing token types
#define EXCLAMATION     128
#define COMMENT         129
#define NL              130
#define FSTRING_START   131
#define FSTRING_MIDDLE  132
#define FSTRING_END     133
#define TSTRING_START   134
#define TSTRING_MIDDLE  135
#define TSTRING_END     136
